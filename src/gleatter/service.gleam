...
import convert
import convert/json as convert_json
...
/// Specify the base type of a service by providing a gleatter_convert type  
/// The base type of a service represent the type of object your service is associated with
pub fn with_base_converter(
  ...
  RouteService(
    service.root_path,
    #(
      fn(val) { val |> convert_json.json_encode(converter) },
      convert_json.json_decode(converter),
    ),
    service.upsert,
  )
}
...
/// Specify the upsert type of a service by providing a gleatter_convert type    
/// The upsert type of a service represent the type used to create or update objects of your service
